...
context-free processes with finite norms (\labelcref{functionality:type-equality
  checking}).
%
This structural-type-equality checking algorithm is also incorporated into the
guide-type-inference algorithm (\labelcref{functionality:type inference}).
%
...
possible traces admitted by the model coroutine (\labelcref{functionality:
  coverage checking}).
